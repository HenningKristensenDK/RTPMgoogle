...
export default function NewCorrespondenceModal({ roles, onCreate, onCancel }: Props) {
  const [type, setType] = useState<CorrespondenceType>("RFI");
  ...
  return (
    ...
    >
      <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl">
        <h2 className="text-[15px] font-semibold text-ink">New correspondence item</h2>
        ...
        <div className="mt-4 flex flex-col gap-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder="e.g. Clarification on foundation rebar spacing"
            />
          </div>
      ...
      {confirmDiscard && (
        ...
        >
          <div className="w-[320px] rounded-card bg-white p-5 shadow-panel">
            <p className="text-sm font-semibold text-ink">Discard this item?</p>
